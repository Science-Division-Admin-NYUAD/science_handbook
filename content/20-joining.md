...
1. Activate your NYU Net ID to use your NYU email account and check your NYU calendar for invitations to upcoming orientation meetings.
2. Download Duo, the cybersecurity app used at NYU, for multi-factor authentication.
3. Install the NYU VPN to access some password-protected sites. The software is automatically installed on NYUAD-issued laptops.
4. Contact the Employee Mobility Team at nyuad.employeemobilityservices@nyu.edu about your travel arrangements.
5. Contact the Immigration Team at immigration.nyuad@nyu.edu with any questions about your visa.
6. Read the Welcome Guide for New Joiners.
7. Complete your Profile Form for the NYUAD website.
8. Request an NYU ID card for your relatives/guests.
9. Review the Guide to NYUAD Systems and Terminology.
10. Explore the NYUAD Intranet for information about events and other offices on campus.
11. Explore the HR page on the Intranet about the steps to organize your health insurance, letters of employment, and other paperwork or settling services. You can also email PeopleLink, NYU's "one-stop shop" for HR, benefits, and payroll inquiries and services.
...
::: card
#### Appointments
Office of Academic Appointments: nyuad.academicappointments@nyu.edu

Office of Research Appointments: nyuad.researchappointments@nyu.edu
:::
::: card
#### Immigration & Benefits
Immigration and Visas: immigration.nyuad@nyu.edu

NYUAD Benefits: nyuad.benefits@nyu.edu
:::
::: card
#### Mobility & Payroll
Employee Mobility: nyuad.employeemobilityservices@nyu.edu

Payroll: nyuad.payroll@nyu.edu
:::
::: card
#### HR & Research Admin
General HR: nyuad.peoplelink@nyu.edu

Post-Award Research Administration: nyuad.postaward-researchadmin@nyu.edu
:::
:::
...
During your time at NYUAD, you will use various platforms to assist with necessary administrative tasks. Below are some quick links:
...
Faculty must complete the following course preparation items in order to adequately prepare to begin teaching a course at NYU Abu Dhabi. Before commencing course preparation, faculty should contact their Program Head or Director of the Core to receive guidance on developing a course description.

1. Create a syllabus and submit it for approval (new courses or significantly revised courses).
2. Make approved syllabi (for new courses) and updated syllabi (for recurring courses) available on the Intranet for students and other university members.
3. Order course books.
4. Order non-text materials by emailing the NYUAD Bookstore.
5. Activate your NYU Brightspace course site.
6. Apply for domestic course-related funding.
7. Submit your software list by emailing nyuad.academictech@nyu.edu.
8. Request other Library services and learn about the Library Liaison Program.
9. Upload all required materials to the Course Archive and Reporting (CAaR) system.

The complete workflow and approval process can be found on the Intranet.

#### Syllabi Submission
NYUAD requires that current syllabi be uploaded for all courses as early as possible and certainly before the start of the term. Updated syllabi for existing courses without any substantive changes can be submitted directly to the web for posting.

Syllabi for new courses or for existing courses with substantive changes need to be reviewed prior to being posted online. Substantive changes ordinarily include, but are not limited to: changes in the course learning objectives, changes in prerequisites, significant changes in the types and/or weighting of graded assignments, and substantive changes to the course description. Minor grammatical or stylistic changes to course descriptions can be made in consultation with the Registrar.

The review process for new or substantively revised courses begins with the Program Head, followed by the Divisional Dean (or Director of the Core), the Divisional Curricular Committee, and then, finally, the Undergraduate or Graduate Curriculum Committee (UCC or GGCC).

Before submitting your syllabus, please read the Syllabi guidelines and review the Syllabi Checklist (PDF) in order to ensure that syllabi are complete. These guidelines list the syllabi components required for university accreditation and will facilitate the cross-listing of courses within the global network university. The checklist will help faculty ensure syllabi satisfy accreditation requirements and are ready, in the case of new or substantively revised courses, to be sent to the Undergraduate Curriculum Committee.

#### Course Book Ordering
Submitting syllabi is a different and separate procedure from ordering course books. Orders for required course books must be submitted directly using the online Course Book Ordering.

Important note: ordering course books through the NYUAD Bookstore does not ensure a copy of each title will be made available in the library. Please submit syllabi to the library to ensure supporting texts and materials for the permanent collection are available.

Some things to keep in mind:

- You can order additional books at any time by following the same guidelines provided above.
- Required items will be issued to each student enrolled in the class.
- Recommended items will be available to students to purchase as desired. Three to five copies will be ordered for each class.
- Status and expected delivery will be regularly updated by the NYUAD Bookstore.
- Other course material (non-text) can be ordered by emailing nyuad.bookstore@nyu.edu, detailing the item you need, including item description, make/model, and quantities.

If you make a mistake or need to edit your order, please contact the bookstore by emailing nyuad.bookstore@nyu.edu.

#### Course Archive and Reporting (CAaRs)
The Course Archive and Reporting (CAaR) system serves as a repository for the syllabus, grading rubrics, exam keys, student work samples, assessment documents, and other materials used in the delivery of a course. An archive record is kept for each semester in which a course is taught. It is compiled by the instructor and archived as part of the continuous quality improvement and accreditation process. It is an important resource in assessing student performance against Course and Program Learning Outcomes, and is required by the UAE's Commission on Academic Accreditation (CAA).

A quick reference guide and a training video are available for all users.

#### NYUAD Bulletin
Find out more about degree requirements, course listings, other programs, course policies and requirements via the NYUAD Bulletin.

#### Albert
Albert is the web interface for the PeopleSoft NYU student information system. Semester grades, course evaluations, and current semester schedules are available through this platform.

#### Brightspace
NYU's learning management system, NYU Brightspace, allows you to create online course websites to support your curricular needs. Instructions on creating a Brightspace site are available on the NYU IT ServiceLink website, and you can also watch a short video on creating a very simple course site. For questions about NYU Brightspace, please contact the Center for Academic Technology at nyuad.academictech@nyu.edu.
...
The Hilary Ballon Center for Excellence in Teaching and Learning offers individual consultations and a variety of workshops to support your teaching and learning needs. It exists to support faculty in bringing the mission and vision of the University to life in the classroom and provides materials, ideas, and a community to support extraordinary teaching.

#### John Sexton and Lisa Goldberg Academic Resource Center (ARC)
The John Sexton and Lisa Goldberg Academic Resource Center (ARC) provides students with resources and support to help them achieve their academic goals. Academic Advisors utilize a student-centered approach and developmental advisory strategies to help new and continuing students succeed through to graduation.

#### Writing Program
Courses offered by the NYUAD Writing Program are opportunities to concentrate intensely on the process of writing. The development of strong writing skills throughout a student's academic career is an important objective of an NYUAD education. The Program champions an integrated understanding of writing as a mode of inquiry and invention; as a means of communicating the results of that inquiry; and as a social and recursive activity.

#### The Office of Undergraduate Research
Research is an important part of education at NYUAD and research opportunities are threaded throughout the undergraduate program across all four academic divisions. Students become active investigators and experience the challenge, creativity, and rigor involved in grappling with unanswered questions, proposing answers, considering problems from new angles, and developing data.

#### Faculty Advancement and Engagement
The Office for Faculty Advancement and Engagement develops and implements strategies and programs so that all faculty can excel as scholars, teachers, and impactful members of the academic community. It fosters a culture of inclusive excellence and life-long learning for faculty at all stages of the academic trajectory by expanding scholarship, educational practices, and service activities to new areas.

#### NYUAD in New York: 19 Washington Square North
Learn about your home away from home in New York City, where you can use an office for research or meetings or request to organize an event that connects NYUAD to NYU in New York.

::: quote
Participate in our cutting-edge research initiatives, take full advantage of the state-of-the-art facilities at your disposal.
:::
...
The University Data Warehouse Plus (UDW+) is a program aimed at establishing decision support services around reporting and analytics. You should use it to manage your research budgets and see your current available budget balance. A UDW+ overview guide is available, in addition to guidelines on research spending. You are advised to review this information carefully.
...
Undergraduate students requesting card access to laboratories, workshops, or equipment rooms must have completed their Laboratory Safety Induction training prior to access being granted. First- and second-year undergraduates will not be granted card access to research laboratories outside of normal operational hours (7am-6pm, Monday-Friday) and should never be permitted to work unsupervised. Third- and fourth-year undergraduates may be granted out-of-hours access on a case-by-case basis as determined by the respective Dean, in consultation with the PI or supervisor of the laboratory in which the student works. Supervision of these students shall be determined on a case-by-case basis by the PI and/or laboratory supervisor. The decision for unsupervised work should be based on the student's competency, hazards present in the work space, and the duties the student will be performing.
...
::: quote
Dive into the wealth of resources and opportunities available within our Division and across the University.
:::
