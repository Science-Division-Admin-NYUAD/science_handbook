...
### Academic Calendar
All academic calendars, including semester start dates, course add/drop periods, and UAE public holidays, are available on the [Intranet](https://intranet.nyuad.nyu.edu/faculty-resources/academic-calendars/).

### Course Preparation & Setup

Before preparing a course, faculty should contact their Program Head or the Director of the Core for guidance on developing the course description. To prepare for teaching at NYU Abu Dhabi, faculty should also complete the following:

1. Create and submit a syllabus for approval for new or significantly revised courses.
2. Make approved new syllabi and updated recurring-course syllabi available on the Intranet for students and other university members.
3. Order course books.
4. Order non-text materials by emailing the NYUAD Bookstore.
5. Activate the NYU Brightspace course site.
6. Apply for domestic course-related funding.
7. Submit the software list to nyuad.academictech@nyu.edu.
8. Request Library services and review the Library Liaison Program.
9. Upload all required materials to the Course Archive and Reporting (CAaRs) system.

The complete workflow and approval process is available on the Intranet.
...
##### Syllabi
Upload current syllabi as early as possible, and always before the start of term. Existing courses without substantive changes can be posted directly.

New or substantively revised courses are reviewed by the Program Head, Divisional Dean or Director of the Core, Divisional Curricular Committee, and UCC or GGCC. Substantive changes include updates to learning objectives or prerequisites, significant changes to graded assignment types or weighting, and substantive course description changes. Minor grammatical or stylistic updates can be made with the Registrar.

Before submitting, use the [Syllabi guidelines](https://intranet.nyuad.nyu.edu/faculty-resources/academics/course-preparation-information/syllabi-creation-and-approval/) and [Syllabi Checklist](https://intranet.nyuad.nyu.edu/faculty-resources/academics/course-preparation-information/syllabi-creation-and-approval/) (PDF) to confirm accreditation requirements, support cross-listing within the global network university, and prepare new or revised syllabi for UCC review.
:::
::: prep-briefing-column
##### CAaRs
Archive each taught course in the [Course Archive and Reporting (CAaRs) system](https://services.nyuad.nyu.edu/caar), including syllabi, grading rubrics, exam keys, student work samples, assessment documents, and other delivery materials.

CAaRs support continuous quality improvement and accreditation, help assess student performance against Course and Program Learning Outcomes, and are required by the UAE's Commission on Academic Accreditation (CAA).

For support with CAaRs, use the [quick reference guide](https://intranet.nyuad.nyu.edu/faculty-resources/academics/syllabi-and-course-requirements/) and [training video](https://intranet.nyuad.nyu.edu/faculty-resources/academics/syllabi-and-course-requirements/caar-training-video/).
:::
:::
:::

::: prep-briefing-block
<p class="prep-kicker">Course Materials</p>

#### Books, Library Copies, and Non-Text Items

Order required books through the online [Course Book Ordering process](https://intranet.nyuad.nyu.edu/faculty-resources/academics/course-preparation-information/course-book-order-form/). This is separate from syllabus submission, and Bookstore orders do not automatically place copies in the Library. Submit syllabi to the Library so supporting texts and materials can be added to the permanent collection.

- Required items are issued to each enrolled student.
- Recommended items are available for purchase, with three to five copies ordered per class.
- Additional books can be ordered at any time using the same guidelines.
- Order status and expected delivery dates are updated regularly by the NYUAD Bookstore.
- For non-text materials, edits, or corrections, email nyuad.bookstore@nyu.edu with the item description, make/model, and quantity.
:::

::: prep-systems-band
#### Course Systems & References

::: prep-system-chipline
<p id="nyuad-bulletin"><strong>NYUAD Bulletin</strong><span>Degree requirements, course listings, programs, course policies, and academic requirements.</span></p>

<p id="albert"><strong>Albert</strong><span>Semester grades, course evaluations, and current schedules.</span></p>

<p id="brightspace"><strong>Brightspace</strong><span>Online course sites, with guidance on the <a href="https://intranet.nyuad.nyu.edu/administrative-services/technology-services/academic-technology/nyu-brightspace/" target="_blank" rel="noopener noreferrer">NYU Brightspace</a> page. Questions? nyuad.academictech@nyu.edu.</span></p>
:::
:::
:::
