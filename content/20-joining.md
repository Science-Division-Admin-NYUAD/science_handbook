...
- Any and all items purchased with research funds are the property of NYUAD and must be returned prior to departure. You can liaise with your program administrative coordinator to return these items.
- Any and all items purchased through or provided by NYUAD IT Services are the property of NYUAD and must be returned prior to departure.
- Your office or workstation must be cleared. Any property left behind will be disposed of.
- Any student-related paperwork should be handed to your program administrative coordinator.
- The keys for any drawers or cabinets must be left in the lock.

Every course instructor, including faculty and visiting faculty, must complete CAaRs for every course taught, and for every semester in which it was taught, before they leave.
